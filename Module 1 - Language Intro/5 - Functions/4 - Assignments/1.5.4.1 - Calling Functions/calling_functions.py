...
samples = random.normal(loc=mu, scale=std, size=num_samples) #edit this line

# Step 3: use mean() to determine the average of those samples
measured_mean = samples.mean() #edit this line

# Step 4: use std() to determine the standard deviation of samples
measured_deviation = samples.std() #edit this line
